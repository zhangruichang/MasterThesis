\chapter{稀疏图上可达性查询隐私保护方法}
\rhead{稀疏图上可达性查询隐私保护方法}

主题模型是一种重要的机器学习模型，在文档处理里面由于能够抽取出隐藏在文档里的主题信息而广泛使用。
LDA是主题模型中最基本也是最经典的模型，他将PLSA贝叶斯化，使得模型更加灵活。LDA是一种聚类，是一种降维，是一种矩阵分解，
本文方法的创新之处在于，将DNA序列按照
...
\section{基于\muihop 的可达性查询的隐私保护算法}
...
\hline
$\g$ & $|$\ppmuihop$|$ & $|T$(\DAG$(\g)$$)|$ & $|V$(\DAG$(\g)$)$|^2$ & 索引构建时间 \\
\hline
